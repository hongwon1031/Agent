...
def main():
    # Parse arguments
    parser = argparse.ArgumentParser(description="Prototype 7 Agent - Dynamic Task Execution")
    ...
    if args.prototype == 7:
        ...
        results_dir = Path(r"C:\Users\NT-165\Desktop\Project\Toy\prototype_7\new_results")
    else:
        print("\n📦 Using Prototype 6: Legacy Agent")
