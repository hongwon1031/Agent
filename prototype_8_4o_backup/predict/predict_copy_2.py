...
MATCH_THRESHOLD = 1.0
# gt_path = Path(r"E:\work\work\Agent\prototype_8_4o_backup\GT\추가데이터_정답\008.신한놀라운종신보험(무배당, 해약환급금 일부지급형)_가입가능조건.json")
# pred_path = Path(r"E:\work\work\Agent\prototype_8_4o_backup\추가데이터_pred\008.사업방법서_신한놀라운종신보험(무배당__해약환급금_일부지급형)_250401_parsed_new_result.json")

# gt_path = Path(r"E:\work\work\Agent\prototype_8_4o_backup\GT\추가데이터_정답\056.신한(간편가입)종신보험 세븐Plus(무배당, 해약환급금 일부지급형)_가입가능조건.json")
# pred_path = Path(r"E:\work\work\Agent\prototype_8_4o_backup\사업방법서_주계약_parser\056.사업방법서_신한(간편가입)종신보험세븐Plus(무배당__해약환급금_일부지급형)_20250401_parsed_new_result.json")

# gt_path = Path(r"E:\work\work\Agent\prototype_8_4o_backup\GT\추가데이터_정답\114.(간편)일반암진단특약(무배당, 해약환급금 미지급형)_가입가능조건.json")
# pred_path = Path(r"E:\work\work\Agent\prototype_8_4o_backup\추가데이터_pred\114.사업방법서_(간편)일반암진단특약(무배당__해약환급금_미지급형)_250401_parsed_new_result.json")

gt_path = Path(r"E:\work\work\Agent\prototype_8_4o_backup\GT\추가데이터_정답\286.(N)남녀특정암진단특약(무배당, 해약환급금 미지급형)_가입가능조건.json")
pred_path = Path(r"E:\work\work\Agent\prototype_8_4o_backup\추가데이터_pred\286.사업방법서_(N)남녀특정암진단특약(무배당__해약환급금_미지급형)_250401_v2_parsed_new_result.json")

#gt_path = Path(r"E:\work\work\Agent\prototype_8_4o_backup\GT\추가데이터_정답\423.(간편)암주요치료비특약(무배당, 해약환급금 미지급형)_가입가능조건.json")
#pred_path = Path(r"E:\work\work\Agent\prototype_8_4o_backup\추가데이터_pred\423.사업방법서_(간편)암주요치료비특약(무배당__해약환급금_미지급형)_250401_parsed_new_result.json")

# --- 원본

#gt_path = Path(r"E:\work\work\Agent\data\토이프로젝트_데이터\추출결과\(간편)[3-100%장해형]재해장해특약(무배당, 해약환급금 미지급형)_가입가능조건.json")
#pred_path = Path(r"E:\work\work\Agent\prototype_8_4o_backup\4o\(간편)[3-100%장해형]재해장해특약(무배당__해약환급금_미지급형)_parsed_single_result.json")
