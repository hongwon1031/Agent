...
MAX_REPLAN_COUNT = 3
MAX_TASK_RETRIES = 3  # NEW: Maximum retries per task (allow more with better backtracking)
MAX_TOTAL_TASKS = 13  # Maximum total number of tasks (including retries) to prevent infinite loops
