    ...
    for tool_name, operations in aggregated.items():
        for operation, stats in operations.items():
            if stats["call_count"] > 0:
                ...
                input_cost = (stats["total_prompt_tokens"] / 1_000_000) * gpt5mini_input
                output_cost = (stats["total_completion_tokens"] / 1_000_000) * gpt5mini_output
...
def main():
    ...
    if len(sys.argv) > 1:
        ...
        path = Path(r"C:\Users\NT-165\Desktop\Project\Toy\prototype_8_5mini\5mini\(간편)[3-100%장해형]재해장해특약(무배당__해약환급금_미지급형)_parsed_single_result copy.json")
