...
gtpath = r"C:\Users\NT-165\Desktop\Project\Toy\data\토이프로젝트_데이터\추출결과\none_일반형_신한종신보험 패밀리케어(무배당, 해약환급금 일부지급형)_가입가능조건.json"
predpath = r"C:\Users\NT-165\Desktop\Project\Toy\prototype_8\4o\none_일반형_신한종신보험 패밀리케어(무배당, 해약환급금 일부지급형)_parsed_single_result.json"
