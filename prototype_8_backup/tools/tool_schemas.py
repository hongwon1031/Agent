...
TOOL_SCHEMAS = {
    ...
    "condition_transform": {
    "description": "Transform raw condition table to normalized schema with lists and age formulas",
    "supported_formats": ["table"],
    "parameters": {
        "header": {
            "type": "list[string]",
            "description": "Original condition table header",
            "required": True,
            "example": "{{task4.data.header}}",
        },
        "data": {
    ...
    "returns": {
        "header": "list[string] - ['보종명','유형1','유형2','보험기간','납입기간',"
                  "'주피보험자최소가입연령','주피보험자최대가입연령',"
                  "'주피보험자최소가입연령구분코드','주피보험자최대가입연령구분코드',"
                  "'주피보험자가입성별']",
        "data": "list[list[any]] - rows where some cells may be lists (기간/납입/성별) "
                "and age fields may contain formulas as strings",
    },
},
