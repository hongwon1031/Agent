...
gtpath = r"C:\Users\NT-165\Desktop\Project\Toy\data\토이프로젝트_데이터\추출결과\(간편)통합암(전이포함)진단특약TC(무배당, 해약환급금 미지급형)_가입가능조건.json"
predpath = r"C:\Users\NT-165\Desktop\Project\Toy\prototype_8\new_results\(간편)통합암(전이포함)진단특약TC(무배당, 해약환급금 미지급형)_parsed_single_result.json"
